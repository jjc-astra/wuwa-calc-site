...
import type { RotationResults, DpsWindowKey } from '../../types/results';
...
export interface ResultsSource {
  ...
  scope?: 'team' | 'personal';
  // DMG Over Time's starting view. Defaults to 2-Min, DMG, line.
  dmgChartDefaults?: { window: DpsWindowKey; mode: 'dmg' | 'dps'; chartType: 'line' | 'bar' };
}
