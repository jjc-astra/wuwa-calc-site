// ==========================================================================
//   TIMELINE ENGINE (Timeline Execution & Event Loop Manager)
// ==========================================================================
const TimelineEngine = {
    ...
    recalculateState: function() {
        ...
        for (let i = 0; i < activeRows.length; i++) {
            ...
            const prevData = i > 0 ? activeRows[i - 1] : RotationState._getDefaultData();
            ...
            if (i === 0) {
                ...
                teamMembers.forEach(charName => {
                    if (charName) {
                        if (RotationState.startEnergy) currentData.energy[charName] = this._getMaxCap(charName, "energy");
                        if (RotationState.startConcerto) currentData.concerto[charName] = this._getMaxCap(charName, "concerto");
                    }
                });
            ...
            // Resolve Detonation Window metrics from move definition schema before snapshotting
        ...
        const emptyRow = RotationState.data[RotationState.data.length - 1];
    ...
    _evaluateMechanics: function(currentData, activeTeam, activeRows, currentIndex) {
        ...
        const prevData = currentIndex > 0 ? activeRows[currentIndex - 1] : RotationState._getDefaultData();
    ...
    _handleResourceEffect: function(resolvedEffect, currentData, targetUnits) {
        ...
        targetUnits.forEach(tName => {
            ...
            if (resKey === "energy") {
                ...
                const stats = (typeof CombatCalculator !== 'undefined') ? CombatCalculator.calculateFinalStats(tName, validBuffs) : (typeof StatCalculator !== 'undefined' ? StatCalculator.calculateFinalStats(tName, validBuffs) : {});
