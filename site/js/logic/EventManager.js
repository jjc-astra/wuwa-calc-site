...
const EventManager = {
    ...
    emit: (eventType, actionModifiers, rowId, activeUnitName, extraPayload = null) => {
        ...
        // Context cache for evaluating off-field units correctly
        const ctxCache = {};
        const getCtx = (unit) => {
